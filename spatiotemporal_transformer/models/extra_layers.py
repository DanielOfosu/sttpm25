...
class ConvBlock(nn.Module):
    ...
    def conv_forward(self, x):
        x = self.conv(x.bfloat16()).bfloat16()
        x = self.norm(x.bfloat16()).bfloat16()
        x = self.activation(x.bfloat16()).bfloat16()
        x = self.pool(x.bfloat16()).bfloat16()
        return x
    ...
    def forward(self, x):
        ...
        x = self.conv_forward(x.bfloat16()).bfloat16()
        x = rearrange(
